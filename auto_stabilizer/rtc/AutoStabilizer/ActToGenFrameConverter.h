...
public:
  ...
  bool convertFrame(const GaitParam& gaitParam, double dt, // input
                    cnoid::BodyPtr& actRobot, std::vector<cnoid::Isometry3>& o_actEEPose, std::vector<cnoid::Vector6>& o_actEEWrench, cpp_filters::FirstOrderLowPassFilter<cnoid::Vector3>& o_actCogVel) const; // output
};
