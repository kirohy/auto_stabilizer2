...
protected:
  ...
  public:
    ...
    RTC::TimedVelocity3D m_refTorsoVel_; // Reference World frame
    RTC::InPort<RTC::TimedVelocity3D> m_refTorsoVelIn_;
    ...
    RTC::TimedDoubleSeq m_wbmsDebug_;
    RTC::OutPort<RTC::TimedDoubleSeq> m_wbmsDebugOut_; // WBMS姿勢/COM操縦のdebug log
  ...
  WbmsPostureControl wbmsPostureControl_;
