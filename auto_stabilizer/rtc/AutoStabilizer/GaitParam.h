...
public:
  ...
  public:
    ...
    double wbmsProjectorQpStructureRebuildDelta = 0.0; // M5.9一時計測. projector QP構造再構築回数の周期増分
    double wbmsProjectorQpFastPathFallbackDelta = 0.0; // M5.9一時計測. projector QP fast path fallback回数の周期増分
